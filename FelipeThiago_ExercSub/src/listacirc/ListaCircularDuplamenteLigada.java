...
public class ListaCircularDuplamenteLigada {
    ...
    public void adicionar(Object item){
     ...
     public void adicionar(Object item, int indice){
        ...
        //NoDuplo(prox, ant, info)
        aux=percorreLista(indice-1);
        
        /* ****Implemente o código necessário para permitir adiciona em qualquer posição da lista *****/
            
        
            //se o parametro passado for maior que a própria lista
            if (indice>qtdNos){
                adicionar(item, indice%qtdNos);
            } else if(indice == 0){
                //se o indice passado for 0, alocar o primeiroNo sendo:
                //anterior - ultimoNo / proximo - primeiroNo
                novoNo = new NoDuplo(primeiroNo, primeiroNo.getAnterior(), item);
                primeiroNo = novoNo;
                qtdNos++;
            } else{
                //se nao for 0 nem o ultimo da lista
                                
                novoNo = new NoDuplo(aux.getProximo(), aux.getAnterior(), item);
    ...
    public String imprimirLista(String resposta, NoDuplo auxiliar, int contador){
        ...
        if(contador< qtdNos-1)//Condicional de Parada
            ...
            return resposta;//** Adicione aqui a resposta do condicional de parada **        
    }
