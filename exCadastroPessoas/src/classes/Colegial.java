...
public final class Colegial extends Aluno implements SalaVirtual{
    ...
    public Colegial(String nome, EnumGenero genero, int idade) throws Exception {
        super(nome, genero, idade);
    }
    public Colegial(String nome, EnumGenero genero, int idade, float nota) throws Exception {
        super(nome, genero, idade);
        this.nota=nota;
    }
