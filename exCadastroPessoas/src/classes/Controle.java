...
public class Controle implements Serializable {
    ...
    public  void addProfessor(String nome, EnumGenero genero, int idade) throws Exception{
        //Criar o professor.
        listaPessoas.add(new Professor(nome,genero,idade));
    }
    public  void addFuncionarioAdm(String nome, EnumGenero genero, int idade) throws Exception{
        //Criar o professor.
        listaPessoas.add(new Administrativo(nome,genero,idade));
    }
    
     public  void addAlunoColegial(String nome, EnumGenero genero, int idade) throws Exception{
        //Criar o professor.
        listaPessoas.add(new Colegial(nome,genero,idade));
    }
    public  void addAlunoFundamental(String nome, EnumGenero genero, int idade) throws Exception{
        //Criar o professor.
    ...
    public String login(int indice){
        ...
        if(p.getClass().equals(Professor.class)){
            ...
            Fundamental fund = (Fundamental) p;
            usuarioLogado = fund;
            return fund.login();
        }
        else{
    ...
    public String logout(){
        ...
        if(usuarioLogado.getClass().equals(Professor.class)){
            ...
            Fundamental fund =(Fundamental) usuarioLogado;
            usuarioLogado = null;
            return fund.logout();
        }
        else{
